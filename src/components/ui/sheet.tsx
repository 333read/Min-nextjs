...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      {...props}
    >
      <SheetPrimitive.Close className="absolute left-4 top-4 rounded-full opacity-70  hover:text-white hover:bg-lime-500 focus:outline-none focus:ring-2 focus:ring-lime-500/85 focus:ring-offset-2">
